...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">ROUTINE MANAGEMENT SYSTEM, INFORMATION SCIENCE ENGINEERING</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/lab1.jpeg" alt="Chania">
        </div>
        ...
        <div class="item">
            <img src="assets/img/lab3.jpg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/lab4.jpg" alt="Flower">
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/f1.png" class="img-rounded"/>
                    <h3 align="center">Prof.</h3>
                    <hr/>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/f2.jpg" class="img-rounded"/>
                    <h3 align="center">PROF. </h3>
                    <hr/>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/f3.png" class="img-rounded"/>
                    <h3 align="center">PROF.</h3>
                    <hr/>
                    <h4 align="center">Chairman<br/>INFORMATION Engineering Department</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4> Said Anywhere</h4>
                <h4><strong>Call:</strong> 6201375845 </h4>
                <h4><strong>Email: </strong>vatsalsamarth45@gmail.com</h4>
            </div>
